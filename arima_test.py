# -*- coding: utf-8 -*-
"""
Created on Fri Jan  4 11:43:23 2019
...
data = pd.read_excel('d:\\brand_dazong.xlsx', index_col = u'日期',header = 0)
print(data.head())
...
for p in range(pmax +1):
    ...
    for q in range(qmax+1):
        try:
            ...
            temp.append(value)
            print(">>>>>p:"+str(p)+" q:"+str(q)+" bic:"+str(value))
...
model = ARIMA(data_float, (p,1,q)).fit()
model.summary2()
